...
if username == "Dad":
    ...
    if password == "Dad":
        ...
        def load_tasks():
            try:
                tasks = pickle.load(open("tasks4.dat", "rb"))
                listbox_tasks.delete(0, tkinter.END)
                for task in tasks:
                    listbox_tasks.insert(tkinter.END, task)
            except:
                tkinter.messagebox.showwarning(title="Warning!", message="Cannot find tasks4.dat.")
        ...
        def save_tasks():
            ...
            pickle.dump(tasks, open("tasks4.dat", "wb"))

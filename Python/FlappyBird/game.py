...
wn.bgcolor("blue")
wn.bgpic("/Users/alexanderlongfellow/Desktop/Stuff/FlappyBird/background.gif")
wn.setup(width=500, height=800)
wn.tracer(0)

wn.register_shape("/Users/alexanderlongfellow/Desktop/Stuff/FlappyBird/bird.gif")
...
player.penup()
player.color("yellow")
player.shape("/Users/alexanderlongfellow/Desktop/Stuff/FlappyBird/bird.gif")
player.shapesize(stretch_wid=None, stretch_len=2, outline=None)
player.goto(-200, 0)
player.dx = 0
player.dy = 1
